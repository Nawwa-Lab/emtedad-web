    ...
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-6 items-start mt-4">
      <Card className="p-7">
        ...
        <Form
          ...
          onSubmit={onSubmit}
        >
          <FormControl name="title" label={t('titleLabel')} labelFor="wish-title">
            {(field, fieldState) => (
              <Input
                id="wish-title"
                type="text"
          ...
          <FormControl name="description" label={t('descriptionLabel')} labelFor="wish-desc">
            {(field, fieldState) => (
              <textarea
                id="wish-desc"
          ...
          <FormControl name="category" label={t('categoryLabel')} labelFor="wish-category">
            {(field, fieldState) => (
              <Select
                name={field.name}
                value={field.value}

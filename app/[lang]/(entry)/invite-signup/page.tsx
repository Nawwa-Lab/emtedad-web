    ...
    <div className="relative w-[min(430px,94vw)]  ">
      <Card>
        <div className="flex items-center gap-3 bg-sage border-line-soft rounded-2xl px-3.5 py-4 mb-5.5">
          <span
            className="w-9.5 h-9.5 shrink-0 rounded-[50%] bg-green grid place-items-center font-display font-bold text-[16px] text-ink "
            aria-hidden="true"
          >
            {firstLetter}
          </span>
        ...
        <CardHeader>
          ...
          <CardDescription>{dict.inviteSignup.description}</CardDescription>
        </CardHeader>
        <CardContent>
          <Field>
          ...
          <Field>
            ...
            <FieldLabel htmlFor="email" className="font-semibold text-[11.5px] mb-1.5 ">
              {' '}
              {dict.inviteSignup.emailNote}
            </FieldLabel>
          </Field>
          <Field>

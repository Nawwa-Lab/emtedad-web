            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                ...
                <aside className="w-full lg:col-span-1">
                    ...
                    <Card className="flex gap-2.5 flex-col p-5.5 mb-4">
                        <Link href="#" className="text-center text-[14px] py-3 px-4 sm:px-5 w-full bg-green text-ink border-0 rounded-[999px] cursor-pointer font-cairo font-extrabold inline-block">
                            {service.requestLink}
                        </Link>
                        <Link href="#" className="text-center text-[13px] py-2.75 px-4 sm:px-5 w-full text-green-deep border border-green-deep hover:bg-green rounded-[999px] cursor-pointer font-cairo font-extrabold inline-block">
